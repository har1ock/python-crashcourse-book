...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Позбавлятись надлишку прибульців та куль.
            self.aliens.empty()
            self.bullets.empty()

            # Створити новий флот та відцентрувати його.
            self._create_fleet()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Видалити всі кулі, що зіткнулися
    ...
    def _update_aliens(self):
        ...
        # Шукати, чи котрийсь із прибульців досяг нижньго краю екрана.
    ...
    def _create_fleet(self):
        ...
        # Визначити, яка кількість рядів прибульця поміщається на екрані.
        ship_height = self.ship.rect.height
        available_space_y = (self.settings.screen_heiht -
    ...
    def _update_screen(self):
         ...
         # Намалювати кнопу Play, якщо гра неактивна.
